...
public record AddressRequestDTO(
    ...
    @Schema(description = "Complemento do endereço (opcional)", example = "Sala 201", nullable = true) String complement,
    ...
    @NotBlank(message = "State is required") @Size(min = 2, max = 2, message = "Estado deve ter exatamente 2 letras (UF)") @Schema(description = "UF do estado (2 letras)", example = "BA", maxLength = 2) String state,

    @NotBlank(message = "ZipCode is required") @ValidCEP @Schema(description = "CEP no formato XXXXX-XXX", example = "40000-000", pattern = "\\d{5}-\\d{3}") String zipCode) {
