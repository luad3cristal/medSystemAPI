...
public class DoctorController {
  ...
  @Operation(
    ...
    description = "Retorna uma lista paginada de todos os médicos ativos no sistema"
  )
  @ApiResponses(value = {
    @ApiResponse(
      responseCode = "200",
  ...
  @Operation(
    ...
    description = "Retorna uma lista paginada de todos os médicos cadastrados no sistema (ativos e inativos)"
  )
  @ApiResponses(value = {
    @ApiResponse(
      responseCode = "200",
  ...
  @Operation(
    ...
    description = "Registra um novo médico no sistema com todas as informações obrigatórias (nome, email, telefone, CRM, especialidade e endereço)"
  )
  @ApiResponses(value = {
    @ApiResponse(
      responseCode = "201",
    ...
    @ApiResponse(
      responseCode = "400",
      description = "Dados inválidos fornecidos (campos obrigatórios ausentes, formato incorreto ou especialidade inválida)",
      content = @Content(mediaType = "application/json")
    ),
    @ApiResponse(
      responseCode = "409",
      description = "Conflito - Médico já cadastrado (email ou CRM duplicado)",
      content = @Content(mediaType = "application/json")
    )
  })
  ...
  @PutMapping("/{id}")
  @Operation(
    summary = "Atualizar dados de médico",
    description = "Atualiza informações de um médico existente, permitindo somente as alterações de nome, telefone e endereço"
  )
  @ApiResponses(value = {
    @ApiResponse(
      responseCode = "200",
  ...
  @Operation(
    ...
    description = "Realiza a exclusão de um médico, tornando-o inativo no sistema"
  )
  @ApiResponses(value = {
    @ApiResponse(
      responseCode = "200",
